 ...
 * <dd>pathname to the content on filesystem; when relative, it is based on directory of project file (project.path)</dd>
 * </li>
 ...
 * </li>
 * </ul>
 * These attributes are also used for script contents that are not formalized in the XSD, for example, 'script' for groovy test step
